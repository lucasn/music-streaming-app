...
export async function getSong(req, res, next) {
    ...
    try {
        const song = await userService.getSong(songId);
...
export async function getSongAudio(req, res, next) {
    ...
    try {
        const songAudio = await userService.getSongAudio(songId);
...
export async function searchSongs(req, res, next) {
    ...
    if(searchString) {
        const songs = await userService.searchSongs(searchString);
